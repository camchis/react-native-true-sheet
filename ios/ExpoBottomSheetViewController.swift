...
protocol ExpoBottomSheetViewControllerDelegate: AnyObject {
...
class ExpoBottomSheetViewController: UIViewController, UISheetPresentationControllerDelegate {
  // MARK: - Properties

  weak var delegate: ExpoBottomSheetViewControllerDelegate?
